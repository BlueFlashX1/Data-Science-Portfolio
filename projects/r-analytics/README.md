...
> University of Arizona, M.S. Data Science. R programming and ggplot2 visualization coursework.
...
Three datasets across wildlife predation (168KB cougar killsite data), occupational safety (28MB workplace fatalities, 146K+ records), and FHFA housing market data. 6 visualizations across 4 numbered figures. Reproducible via `setup.R` + `rmarkdown::render`.
