...
This portfolio demonstrates proficiency in R programming, statistical graphics, and visual storytelling through comprehensive data visualization projects spanning wildlife ecology, occupational safety, and economic indicators.

### Visualization Techniques Demonstrated

- **Basic Plots**: Pie charts and bar charts for categorical data
- **Grouped Visualizations**: Multi-category comparisons with grouped bar charts
- **Faceted Plots**: Small multiples for regional/temporal breakdowns
- **Advanced Plots**: Alluvial diagrams, area plots, line graphs
- **Statistical Summaries**: Descriptive statistics tables

## Project Files

| File                                                                                           | Size  | Description                                            |
| ---------------------------------------------------------------------------------------------- | ----- | ------------------------------------------------------ |
| [`Final Portfolio Assignment(Finished).Rmd`](<./Final%20Portfolio%20Assignment(Finished).Rmd>) | 43KB  | Complete portfolio source code with all visualizations |
| [`MatthewThompson_Final_Portfolio.pdf`](./MatthewThompson_Final_Portfolio.pdf)                 | 399KB | **Rendered portfolio (view this for complete work)**   |
| [`Final-Portfolio-Assignment.pdf`](./Final-Portfolio-Assignment.pdf)                           | 399KB | Alternative PDF version                                |
| [`Data Dictionary Function.R`](./Data%20Dictionary%20Function.R)                               | 3.7KB | Custom R function for automated data exploration       |
| [`Final Portfolio.Rproj`](./Final%20Portfolio.Rproj)                                           | 253B  | R project configuration                                |
...
├── Final Portfolio Assignment(Finished).Rmd      # Complete portfolio source code
├── MatthewThompson_Final_Portfolio.pdf           # Rendered portfolio (399KB)
├── Final-Portfolio-Assignment.pdf                # Alternative PDF version
...
_Transforming complex data into compelling visual narratives through R and ggplot2_
