...
|------|---------|----------|
| `train.csv` | 587,801 | Training set with features and target |
| `dev.csv` | 125,958 | Development / validation set with features and target |
| `test.csv` | features only | Held-out test set |
| `submission.csv` | n/a | Model predictions on the test set |
...
`readmitted_within_30_days` is binary: whether the patient was readmitted to a hospital within 30 days of an encounter.
