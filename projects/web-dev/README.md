...
- **Technologies**: R Shiny, HTML/CSS/JavaScript, Bootstrap

### Data Visualization Gallery
- **Description**: Interactive data visualizations and storytelling
...
- **Database**: SQL integration, data management
